...
run = undefined  }) => {
   ...
   const showAddToCardbtn = (showAddToCartButton ) => {
      return showAddToCartButton && (
         <button onClick={addToCart}  className="btn btn-sm btn-outline-warning mt-2 mb-2">
            Add to Cart
         </button>
      )
   }
   ...
   const showRemoveButton = (showRemoveProductButton ) => {
      return showRemoveProductButton && (
         ...
         setRun(!run); }}  className="btn btn-sm btn-outline-danger mt-2 mb-2">
            Remove Product
         </button>
      )
   }
   ...
   return (
         <div className="card ">
            ...
            <div className="card-body">
               ...
               <p className="black-9">
                Categoty: {product.category && product.category.name}</p>
                <p className="black-8">
               ...
               {showAddToCardbtn(showAddToCartButton)}
